...
{{--                                            @endif--}}
                                        ...
                                        <td>
                                            <form action="{{ route('users.destroy', $row->id) }}" method="POST">
                                                ...
                                                <a href="{{ route('users.roles', $row->id) }}" class="btn btn-info btn-sm"><i class="fa fa-user-secret">Roles</i></a>
                                                <a href="{{ route('users.edit', $row->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit">Edit</i></a>
